%% Generate Leftward Prior Trial for Perisaccadic Mislocalization Task 
...
function [frame_info, x_location, condition, dur_F1, dur_F2, dur_probe, dur_F2afterprobe, F1_location, F2_location] = generate_trial_leftwardprior(dist_to_screen, frame_rate, ppcmx)
...
%the left hemifield 75% of the time 
%for case 75% on the left~leftward prior
    if randn()-0.5>=0
